const plugin = {
  ...
  async renderEmbed(app) {
    ...
    function loadSettingsIntoConfig() {
      ...
      const fpConfigUpdatedFieldsString = JSON.stringify(fpConfigUpdatedFields).slice(0, -2); //to remove comma and closed bracket

      console.log("fpConfig be like", fpConfigUpdatedFieldsString);
