(() => {
  ...
  var helpers = () => {
    ...
    function drawRefreshButton(onClick) {
      ...
      const refreshButton = utilities.newHTMLElement("div", "refreshButton", "smol-button refresh", [utilities.getMaterialIcon("refresh")], [[{ eventName: "click", eventAction: () => onClick(today) }]]);
    ...
    function drawTodayButton(fpInstance, onClick) {
      ...
      if (fpInstance.currentMonth !== today.getMonth() || fpInstance.currentYear !== today.getFullYear())
        todayButton = utilities.newHTMLElement("div", "todayButton", "smol-button", [utilities.getMaterialIcon("prompt_suggestion")], [{ eventName: "click", eventAction: () => onClick(today) }]);
      else
        todayButton = utilities.newHTMLElement("div", "todayButton", "smol-button hidden", [utilities.getMaterialIcon("prompt_suggestion")]);
    ...
    function drawSettingsButton(onClick) {
      ...
      const settingsButton = utilities.newHTMLElement("div", "settingsButton", "smol-button settings", [utilities.getMaterialIcon("settings")], [{ eventName: "click", eventAction: () => onClick() }]);
