  ...
  <script>
    ...
    function drawRibbon(currentMonth, userTags, jotsCount) {
      ...
      if (currentMonth !== "${today}") {
        ...
        todayButton.append(getMaterialIcon("prompt_suggestion"), "${today}");
        todayButton.addEventListener("click", function () {
          console.log("ribbon back to today clicked!")
      ...
      userTags.split(",").forEach((tag) => {
        ...
        tagElement.setAttribute("class", "mdc-chip");
        tagElement.append(getMaterialIcon("tag"), tag);
        userTagDisplay.append(tagElement);
      });
      userTagDisplay.setAttribute("class", "current-month tags");
      ...
      jotCount.append(getMaterialIcon("description"), jotsCount);
