const plugin = {
  ...
  getWeekOfDate(date, firstDayOfWeek = 1) {
...
<body>
  ...
  <script>
    ...
    function drawTodayButton(fpInstance) {
    ...
    function drawRefreshButton(fpInstance) {
    ...
    function drawSettingsButton(fpInstance) {
    ...
    function redrawCalendar(fp) {
      ...
      drawRefreshButton(fp);
      drawTodayButton(fp);
      drawSettingsButton(fp);
      drawWeeklyNotes(fp);
      refreshRibbon(fp);
    }

    function refreshRibbon(fpInstance) {
